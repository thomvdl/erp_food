...
/**
 * "Mettre en place l'authentification pour app et validate event" (voir Readme.md). Même
 * mécanisme que erp-app (token Sanctum en Bearer, pas de cookie) — voir erp-app/core/auth.service.ts
 * pour le détail, dupliqué ici plutôt que partagé car ce sont deux workspaces Angular séparés.
 */
