...
/**
 * Écran de connexion du kiosque — scan QR par défaut (badge personnel, pas de clavier physique
 * sur une tablette d'entrée d'événement), avec un repli "mot de passe" au clavier visuel pour
 * les cas où un utilisateur n'a pas encore de QR généré (voir erp-app/parametres/utilisateurs).
 */
@Component({
  selector: 'app-login',
  standalone: true,
...
export class Login implements OnDestroy {
  ...
  /**
   * Le clavier visuel n'affiche que des lettres majuscules (convention d'un clavier physique)
   * mais ça ne veut pas dire que la saisie doit l'être — les identifiants/mots de passe seedés
   * sont en minuscules, taper "ADMIN"/"PASSWORD" au lieu de "admin"/"password" empêchait toute
   * connexion. Minuscule par défaut, "⇧ Maj" bascule en majuscule (façon verrouillage majuscule,
   * pas une vraie touche Shift à relâcher).
   */
  ...
  // --- Saisie clavier visuel (mot de passe) ---
  ...
  // --- Scan QR (caméra) — même pattern que event-checkin ---
