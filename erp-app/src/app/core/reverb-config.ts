...
// mappé sur le port interne 8080 du conteneur reverb (voir docker-compose.yml / .env). En prod,
// `window.__ERP_CONFIG__` (voir docker/env.template.js) prend le dessus.
