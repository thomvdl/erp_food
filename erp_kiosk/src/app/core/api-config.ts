...
// les appels API partiraient vers le "localhost" de l'appareil affichant la page. En prod,
// `window.__ERP_CONFIG__` (voir docker/env.template.js) prend le dessus avec la vraie URL du
// domaine.
