 ...
 * changement de stock d'un produit SUIVI (vente réelle, ou réapprovisionnement manuel depuis
 * erp-app > Paramètres > Produits) — jamais pour un produit à stock non suivi. Utilisé par
 * kiosk-order.ts pour dégriser/griser une tuile produit en direct sans recharger le menu.
 */
