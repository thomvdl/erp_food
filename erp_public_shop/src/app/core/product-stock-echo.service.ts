 ...
 * stock non suivi. Utilisé par pages/catalog pour dégriser/griser une tuile produit en direct
 * pendant que le client compose son panier — même service que erp_self_order (canal public,
